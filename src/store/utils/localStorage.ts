...
// Storage keys
export const STORAGE_KEY = "agent1-workflow-configs";
export const COST_DATA_STORAGE_KEY = "agent1-workflow-costs";
export const GENERATE_IMAGE_DEFAULTS_KEY = "agent1-nanoBanana-defaults";
export const PROVIDER_SETTINGS_KEY = "agent1-provider-settings";
export const RECENT_MODELS_KEY = "agent1-recent-models";
export const NODE_DEFAULTS_KEY = "agent1-node-defaults";
export const CANVAS_NAVIGATION_KEY = "agent1-canvas-navigation";
