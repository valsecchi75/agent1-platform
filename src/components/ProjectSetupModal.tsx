...
export function ProjectSetupModal({
  ...
  useEffect(() => {
    const saved = localStorage.getItem('agent1-skin') || 'aurora';
              ...
              {([
                {
                  ...
                  colors: ['#0c0f14', '#b8973a', '#181c25'],
                },
                {
                  id: 'ember',
                  name: 'Ember',
                  desc: 'Iconic · Black & Heritage Red',
                  colors: ['#D31920', '#0a0a0a', '#f5f5f5'],
                },
                {
                  id: 'matrix',
                  name: 'Matrix',
                  desc: 'Digital · Black & Neon Green',
                  colors: ['#4CAF50', '#0c1014', '#8a9098'],
                },
                {
                  id: 'sienna',
                  name: 'Sienna',
                  desc: 'Italian Craft · Havana & Amber',
                  colors: ['#8B572A', '#120e0a', '#ede6dc'],
                },
                {
                  id: 'sage',
                  name: 'Sage',
                  desc: 'Quiet Luxury · Sage & Earth',
                  colors: ['#6B705C', '#0e1210', '#e4e6e2'],
                },
                {
                  id: 'orchid',
                  name: 'Orchid',
                  desc: 'Fashion Bold · Purple & Editorial',
                  colors: ['#7B2D8E', '#100c16', '#eae4ec'],
                },
                {
                  id: 'platinum',
                  name: 'Platinum',
                  desc: 'Minimal · Silver & Steel',
                  colors: ['#A0A0A8', '#101214', '#e8e8ea'],
                },
                {
                  id: 'abyss',
                  name: 'Abyss',
                  desc: 'Deep · Navy & Midnight',
                  colors: ['#1B3A5C', '#080c14', '#d4dce8'],
                },
                {
                  id: 'amber',
                  name: 'Amber',
                  desc: 'Warm · Gold & Honey',
                  colors: ['#B8860B', '#0e0c08', '#ece4d0'],
                },
                {
                  id: 'ocean',
                  name: 'Ocean',
                  desc: 'Cool · Teal & Deep Sea',
                  colors: ['#008B8B', '#081210', '#d0e8e8'],
                },
              ] as const).map((skin) => {
                ...
                return (
                  <button
                    ...
                    className={`text-left rounded-xl overflow-hidden transition-all duration-150 ${isActive ? 'ring-2' : 'ring-1 ring-neutral-700 hover:ring-neutral-500'}`}
                    style={isActive ? { '--tw-ring-color': 'var(--accent)' } as React.CSSProperties : {}}
                  >
                    {/* Color swatches bar */}
                    ...
                    <div className="p-3 bg-neutral-900">
                      <div className="flex items-center gap-2">
                        <span className="text-xs font-bold text-neutral-100">{skin.name}</span>
                        {isActive && (
                          <svg className="w-3.5 h-3.5" style={{ color: 'var(--accent)' }} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3">
                            <path d="M20 6L9 17l-5-5" />
                          </svg>
                        )}
                      </div>
                      <p className="text-[10px] text-neutral-500 mt-0.5">{skin.desc}</p>
                    </div>
                  </button>
                );
              })}
