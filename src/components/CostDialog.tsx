      ...
      <DialogContent size="md">
        <DialogHeader>
          <div className="flex items-center justify-between">
            <div>
              <DialogTitle>Workflow Cost Dashboard</DialogTitle>
              <DialogDescription>Estimated and incurred costs for this workflow</DialogDescription>
            </div>
            {incurredCost > 0 && (
              <button
                onClick={handleReset}
                className="px-2.5 py-1 text-[10px] rounded-md transition-colors mr-8"
