                  ...
                  <>
                    ...
                    {toolInvocations.map((tool, idx) => {
                      ...
                      if (toolName === "createWorkflow") {
                        return (
                          <div key={idx} className="mb-2 text-[var(--accent)] text-xs italic">
                            Building workflow...
                          </div>
                        );
                      }
        ...
        >
          <div className="flex gap-2">
            <input
              ...
              className="flex-1 bg-neutral-700 border border-neutral-600 rounded-lg px-3 py-2 text-sm text-neutral-200 placeholder-neutral-500 focus:outline-none focus:border-[var(--accent)]"
              disabled={isLoading}
            />
            <button
              type="submit"
              disabled={isLoading || !input.trim()}
              className="px-3 py-2 bg-[var(--accent)] text-[var(--btn-primary-text)] rounded-lg text-sm font-medium hover:bg-[var(--accent-hover)] disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
            >
              <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        {hasConversation && onBuildWorkflow && (
          <div className="px-3 pb-3">
            <button
              ...
              className="w-full bg-green-600 hover:bg-green-500 text-neutral-50 rounded-lg px-4 py-2 text-sm font-medium disabled:opacity-50 disabled:cursor-not-allowed transition-colors flex items-center justify-center gap-2"
            >
              {isBuildingWorkflow ? (
                <>
