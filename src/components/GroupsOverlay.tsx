          ...
          >
            {isEditing ? (
              <input
                ...
                className="bg-transparent border-none outline-none text-xs font-medium text-neutral-50 px-0 py-0"
                style={{ minWidth: 60, maxWidth: 200, width: `${Math.max(60, editName.length * 7)}px` }}
              />
            ) : (
              <span
                className="text-xs font-medium text-neutral-50 truncate"
                style={{ maxWidth: 200 }}
      ...
      >
        <div className="flex items-center gap-1 px-1.5 py-0.5">
          ...
          <button
            ...
            className="p-0.5 rounded hover:bg-neutral-50/20 text-neutral-50/70 hover:text-neutral-50 transition-colors"
