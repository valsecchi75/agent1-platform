...
export function GroupNode({ id, data, selected }: NodeProps<GroupNodeType>) {
  ...
  // Note: no text-white to fix in this section
        ...
        >
          ...
          {isEditing ? (
            <input
              ...
              className="flex-1 bg-transparent border-none outline-none text-sm font-medium text-neutral-50 px-0 py-0"
              style={{ minWidth: 0 }}
            />
          ) : (
            <span
              className="flex-1 text-sm font-medium text-neutral-50 truncate cursor-text"
          ...
          <button
            ...
            className="p-0.5 rounded hover:bg-white/20 text-neutral-400 hover:text-neutral-50 transition-colors"
            title="Delete group"
          >
            <X className="w-4 h-4" />
          </button>
